...
#############################################################
	...
	constraint wall normal 1 0 0 dist [expr 0.0001] type $type_wall
 	...
 	# wall at the opposite side, normal is pointing up in negative x
 	# do not use a slit height less than 2!
	set slit_height 5 
	constraint wall normal -1 0 0 dist [expr -(0.0001+$slit_height)] type $type_wall
